...
token = "OTAyNzQwODQwMTgxNTQyOTc0.YXi07A.DiKx3Js95gOeitl9sjldo83NF04"
cat_key = config.get('cat_key')
weather_key = config.get('weather_key')
intents = disnake.Intents().all()
bitly_key = config.get('bitly_key')
bot = commands.Bot(command_prefix=commands.when_mentioned_or('Luv', 'Eru', 'eru', 'luv', 'love', 'Love'), strip_after_prefix = True, intents = intents, sync_commands_debug=True)
